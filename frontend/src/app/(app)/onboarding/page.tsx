...
import { useAppStore, EquipmentAccess, ExperienceLevel, FitnessGoal } from '@/store/user-store'
...
const onboardingSchema = z.object({
  ...
  primaryGoal: z.enum(['muscle', 'fat_loss', 'endurance', 'mobility', 'general_health']),
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">We will customize your plan and quests.</p>
      </div>
      <Form {...form}>
