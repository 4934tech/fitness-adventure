  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28 text-center">
        ...
        >
          Personalized plans adapt to you. Complete quests, earn XP and coins, and stay consistent with streaks and analytics.
        </motion.p>
        ...
        >
          {[{label:'Members leveled up',value:'25k+'},{label:'Avg. weekly XP',value:'1.2k'},{label:'Daily quests',value:'500+'},{label:'Countries',value:'60+'}].map((s)=> (
            <div key={s.label} className="fa-gradient-border rounded-lg p-[1px]">
