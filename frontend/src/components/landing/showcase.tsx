        ...
        <div className="fa-glass rounded-[inherit] p-6 sm:p-10">
          <div className="grid items-center gap-6 sm:grid-cols-2">
            <div>
              ...
              >
                We generate adaptive workouts and quests. When life shifts, your plan shifts—keeping streaks alive.
              </motion.p>
            </div>
            <motion.div
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 grid grid-cols-3 gap-2">
                {['XP +200', 'Streak +1', 'Coins +15'].map((t) => (
                  <div key={t} className="fa-gradient-border rounded-lg p-[1px]">
